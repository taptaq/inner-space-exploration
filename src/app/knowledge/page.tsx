...
export default function KnowledgePage() {
  ...
  const filteredCards =
    activeCategory === "all"
      ? knowledgeCards
      : knowledgeCards.filter((c) => c.category === activeCategory);
    ...
    <main className="min-h-screen bg-brand-slate-950 text-white font-mono relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 pt-6 pb-20">
        ...
        <header className="mb-8">
          ...
          <h1 className="text-2xl sm:text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-brand-cyan-100 to-brand-cyan-500 tracking-tight mb-2">
            📚 深空医典
          </h1>
