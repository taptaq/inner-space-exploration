        ...
        <div className="z-10 w-full max-w-lg bg-brand-slate-900/80 border border-brand-emerald-500/30 rounded-lg p-6 md:p-8 backdrop-blur-md shadow-[0_0_40px_rgba(16,185,129,0.1)] animate-[fadeInTop_0.5s_ease-out]">
          ...
          <div className="flex flex-col gap-4">
            <button
              ...
              className="w-full py-4 bg-brand-emerald-500/10 border-2 border-brand-emerald-500 text-brand-emerald-400 font-black tracking-widest uppercase md:hover:bg-brand-emerald-500 md:hover:text-brand-slate-950 active:bg-brand-emerald-500 active:text-brand-slate-950 transition-all rounded shadow-[0_0_20px_rgba(16,185,129,0.2)]"
            >
              [ 确认重组此人格，直接升舱 ]
            </button>
            <button
              onClick={() => setPhase("scenario")}
              className="w-full py-3 bg-transparent border border-brand-slate-700 text-brand-slate-400 text-sm tracking-widest uppercase md:hover:bg-brand-slate-800 md:hover:text-white active:bg-brand-slate-800 active:text-white transition-all rounded"
            >
              推翻诊断，进行手动场景实测
            </button>
          </div>
        ...
        >
          ...
          <div className="flex flex-col md:pr-8">
            <div className="mb-6 sm:mb-8 px-4 md:px-0">
              ...
              {/* 语音控制区 */}
              <div className="mt-4 flex items-center justify-center md:justify-start gap-3"></div>
            </div>
